export function LoginForm() {
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="w-full  sm bg-accent1 p-2 text-center font-bold text-white hover:bg-accent1">
        Log in
      </div>
      <div className="w-full  sm border border-accent1 p-2 text-center font-bold text-accent1">
        Create login
      </div>
    </div>
  );
